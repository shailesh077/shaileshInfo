...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      // image: "/api/placeholder/600/400",
      description:
        "A full-featured shopping application with payment integration.",
    ...
    },
    {
      ...
      // image: "/api/placeholder/600/400",
      description:
        "Content management system with authentication and comment system.",
  ...
  return (
    <section className="py-20 bg-gray-900 relative">
      ...
      <div className="container mx-auto px-4 md:px-8">
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    ...
                    {project.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="text-xs bg-blue-900/50 text-blue-200 py-1 px-2 rounded"
                      >
                        {" "}
                        {tech}{" "}
                      </span>
        ...
        >
          <a
            href="https://github.com/shailesh077"
            target="_blank"
